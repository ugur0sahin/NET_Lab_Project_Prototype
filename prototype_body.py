...
database=pd.read_csv('prototype_db.csv',sep=';')
print(database)
...
for index, row in database.iterrows():
    assign_node(G,Gene(row['Gene_Symb'],row['Transcription_Level'],row['CRISPR_KO_Effect'],row['Hotpoint_Mutation'],row['Differentiation_Rate']))
